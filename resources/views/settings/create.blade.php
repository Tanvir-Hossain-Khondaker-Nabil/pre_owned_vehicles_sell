...
@slot('title') Setting Create @endslot
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title mb-4"> Setting Form</h4>
                <form method="POST" action="{{route('settings.store')}}">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6">
                            <x-input label='Serial Number' :required=true placeholder="Serial Number" name="serial_no"
                                value="{{old('serial_no')}}">
                            </x-input>
                        </div>
