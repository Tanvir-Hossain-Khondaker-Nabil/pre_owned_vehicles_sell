        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li><a href="{{ route('services.create') }}" key="t-level-1-1">Create</a></li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li><a href="{{ route('expense-categories.index') }}" key="t-level-1-2">Expense Category</a>
                        </li>
                        <li><a href="{{ route('expenses.index') }}" key="t-level-1-2">Expense List</a></li>
                        <li><a href="{{ route('expenses.create') }}" key="t-level-1-1">Add Expense</a></li>
                    </ul>
                </li>
                {{-- Accounting Menu-bar --}}
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="true">
                        <li>
                            <a href="{{ route('accounts.index') }}" key="t-level-1-2">Account List</a>
                        </li>
                        <li>
                            <a href="{{ route('accounts.create') }}" key="t-level-1-1">Add Account</a>
                        </li>
                        <li>
                            <a href="#" key="t-level-1-2">Money Transfer</a>
                        </li>
                        <li>
                            <a href="{{ url('balance-sheet') }}" key="t-level-1-2">Balance Sheet</a>
                        </li>
                        <li>
                            <a href="{{ url('account-statement') }}" key="t-level-1-2">Account statement</a>
                        </li>
                    </ul>
                </li>
            </ul>
