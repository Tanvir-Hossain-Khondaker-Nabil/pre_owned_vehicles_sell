        ...
        <div class="modal-body">
            <form wire:submit=save>
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <x-livewireinput label='Phone' :required=true type="tel" placeholder="Enter Your Phone"
                            name="phone">
                        </x-livewireinput>
                    </div>
                    ...
                    <div class="mt-2">
                        ...
                        <textarea class="form-control form-control-lg ps-3" required wire:model="address" id=""
                            cols="30" rows="2" placeholder="Enter Your Address"></textarea>
                    </div>
