    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST"
                    action="{{(@$workshop) ? route('workshops.update',$workshop->id) : route('workshops.store')}}"
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <x-input label='Work Shop Name' :required=true placeholder="Enter Shop Name" name="work"
                                value="{{@$workshop->work ?? old('work')}}">
                            </x-input>
                        </div>
                                    ...
                                    <tr data-id="{{$sl++}}">
                                        ...
                                        {{-- <td style="width: 100px">
                                            <a class="btn btn-outline-secondary btn-sm edit"
                                                href="{{route('workshops.edit', $workshop->id)}}" title="Edit">
